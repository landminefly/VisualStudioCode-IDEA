package test10_3.DAO.Implement;

import bean.Customer;
import test10_3.DAO.BaseDAO;
import test10_3.DAO.CustomerDAO;

import java.sql.Connection;
import java.sql.Date;
import java.util.List;

public class CustomerDAOImplement extends BaseDAO implements CustomerDAO
{
    ...
    public Customer getCustomerById(Connection connection, int id)
    {
        ...
        return selectForOneWithTx(connection,Customer.class,sql,id);
    }
    ...
    public List<Customer> getAll(Connection connection)
    {
        ...
        return selectNotForOneWithTx(connection,Customer.class,sql);
    }
